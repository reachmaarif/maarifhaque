...
<Columns columns={3}>
  <div>
    <h6 class="font-PPBold">Hot spots</h6>
  ...
  <div>
    <h6 class="font-PPBold">Learn tabs</h6>
  ...
  <div>
    <h6 class="font-PPBold">Tutorial projects</h6>
...
<br />
<h6 class="font-PPBold">Existing In-app help</h6>
<Columns columns={2}>
  <div>
    <h6 class="font-PPBold">Onboarding</h6>
  ...
  <div>
    <h6 class="font-PPBold">Coachmarks</h6>
...
<Columns columns={3}>
  ...
  <div>
  ###### In-App
  <h6 class="font-PPBold">Featured tooltips:</h6>
  Remove coachmarks. Let the user initiate rich tooltips when they want to learn about a particular tool/feature.
    
  <h6 class="font-PPBold">Contextual tips:</h6>
  Instead of random coachmarks which block the user's workspace, trigger non-intrusive contextual learn content based on user action.
  </div>
</Columns>
